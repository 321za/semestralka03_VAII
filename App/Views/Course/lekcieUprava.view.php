                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="fcf-form-group">
                            ...
                            <input type="text" value="<?= @$data['caption'] ?>" class="fcf-form-control" name="caption"
                                   required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="fcf-form-group">
                            ...
                            <input type="text" value="<?= @$data['info'] ?>" class="fcf-form-control" name="info"
                                   required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="fcf-form-group">
                            ...
                            <input type="text" value="<?= @$data['time'] ?>" class="fcf-form-control" name="time"
                                   required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="fcf-form-group">
                            ...
                            <input type="number" value="<?= @$data['capacity'] ?>" class="fcf-form-control"

...
<div class="container">
    <div class="row">
        ...
        <p>Flexi yoga je nenáročná forma yogy, vhodná pre začiatočníkov a pokročilých, pre športovcov ako forma
            strečingu, ale aj pre tých, ktorých trápi sedavé zamestnanie. Jemné ťahy svalov, práca s dychom uľavujúca
            nielen v zatuhnutých častiach tela, relaxácia a pomalšie tempo prinesú uvoľnenie pri každodenných pohyboch
            (hlboký predklon, vystretie končatín, rotácia chrbta, otváranie panvy) a pomôžu obnoviť pohyb v žiaducich
            partiách.</p>
